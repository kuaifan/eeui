package com.tiantian.weiui.extend.tablayout;
...
import com.tiantian.weiui.extend.tablayout.utils.FragmentChangeManager;
import com.tiantian.weiui.extend.tablayout.utils.UnreadMsgUtils;
import com.tiantian.weiui.extend.tablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void addTab(final int position, View tabView) {
        ...
        setImageView(false, mTabEntitys.get(position), iv_tab_icon);
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                setImageView(i == mCurrentTab, tabEntity, iv_tab_icon);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
            CustomTabEntity tabEntity = mTabEntitys.get(i);
            setImageView(isSelect, tabEntity, iv_tab_icon);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    private void setImageView(boolean isCurrent, CustomTabEntity tabEntity, ImageView icon) {
                ...
                Glide.with(icon.getContext())
                        ...
                        .listener(new RequestListener<Drawable>() {
                            ...
                            public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                                imageViewHeight.put(iconUrl, resource.getIntrinsicHeight());
                                return false;
                            }
                        }).into(icon);
            } else {
