...
import vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.UnitTranscoder;
import vip.kuaifan.weiui.extend.integration.glide.util.MultiClassKey;
import java.util.Collections;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
