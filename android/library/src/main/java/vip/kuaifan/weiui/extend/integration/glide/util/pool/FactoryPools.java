package vip.kuaifan.weiui.extend.integration.glide.util.pool;
 ...
 * created, and that can use the {@link vip.kuaifan.weiui.extend.integration.glide.util.pool.FactoryPools.Poolable}
