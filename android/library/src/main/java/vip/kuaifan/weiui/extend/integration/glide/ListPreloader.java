...
import vip.kuaifan.weiui.extend.integration.glide.request.target.BaseTarget;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     * {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#override(int, int)} to do so.
     *
  ...
  /**
   * Constructor for {@link vip.kuaifan.weiui.extend.integration.glide.ListPreloader} that accepts interfaces for providing
