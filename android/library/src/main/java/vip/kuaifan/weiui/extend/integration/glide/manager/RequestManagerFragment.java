 ...
 * vip.kuaifan.weiui.extend.integration.glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see vip.kuaifan.weiui.extend.integration.glide.manager.SupportRequestManagerFragment
 * @see vip.kuaifan.weiui.extend.integration.glide.manager.RequestManagerRetriever
 * @see vip.kuaifan.weiui.extend.integration.glide.RequestManager
 */
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager} or null if none exists.
   */
  @Nullable
