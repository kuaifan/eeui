...
import vip.kuaifan.weiui.extend.integration.glide.gifdecoder.GifHeader;
import vip.kuaifan.weiui.extend.integration.glide.gifdecoder.GifHeaderParser;
import vip.kuaifan.weiui.extend.integration.glide.gifdecoder.StandardGifDecoder;
...
import vip.kuaifan.weiui.extend.integration.glide.load.resource.UnitTransformation;
...
/**
 * An {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder} that decodes {@link
 * vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable} from {@link java.io.InputStream} data.
 */
