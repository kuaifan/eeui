...
import vip.kuaifan.weiui.extend.integration.glide.load.data.HttpUrlFetcher;
import vip.kuaifan.weiui.extend.integration.glide.load.model.GlideUrl;
import vip.kuaifan.weiui.extend.integration.glide.load.model.ModelCache;
...
/**
 * An {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader} for translating {@link
 * vip.kuaifan.weiui.extend.integration.glide.load.model.GlideUrl} (http/https URLS) into {@link java.io.InputStream} data.
 */
// Public API.
...
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT = Option.memory(
      "vip.kuaifan.weiui.extend.integration.glide.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);
