...
public interface Transformation<T> extends Key {
   ...
   * vip.kuaifan.weiui.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  vip.kuaifan.weiui.extend.integration.glide.request.target.Target#SIZE_ORIGINAL} to indicate the
