...
import vip.kuaifan.weiui.extend.integration.glide.load.data.BufferedOutputStream;
...
/**
 * An {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceEncoder} that writes {@link android.graphics.Bitmap}s
...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
  ...
  public static final Option<Integer> COMPRESSION_QUALITY = Option.memory(
      "vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);
  ...
  public static final Option<Bitmap.CompressFormat> COMPRESSION_FORMAT = Option.memory(
      "vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");
