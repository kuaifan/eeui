...
/**
 * For a given {@link vip.kuaifan.weiui.extend.integration.glide.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.DecodePath}s.
 *
