...
/**
 * Generates {@link vip.kuaifan.weiui.extend.integration.glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader ModelLoaders} and the model
