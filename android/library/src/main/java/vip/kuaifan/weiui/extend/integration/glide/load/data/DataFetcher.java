 ...
 *
 * <p> A new instance is
 * created per resource load by {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader}. {@link
 * #loadData(vip.kuaifan.weiui.extend.integration.glide.Priority, vip.kuaifan.weiui.extend.integration.glide.load.data.DataFetcher.DataCallback)}
 ...
 * {@link #loadData(vip.kuaifan.weiui.extend.integration.glide.Priority,
 * vip.kuaifan.weiui.extend.integration.glide.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called. </p>
 *
...
public interface DataFetcher<T> {
   ...
   * finally block after the data provided by {@link #loadData(vip.kuaifan.weiui.extend.integration.glide.Priority,
   * vip.kuaifan.weiui.extend.integration.glide.load.data.DataFetcher.DataCallback)} has been decoded by the
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
  ...
  /**
   * Returns the {@link vip.kuaifan.weiui.extend.integration.glide.load.DataSource} this fetcher will return data from.
   */
  @NonNull
