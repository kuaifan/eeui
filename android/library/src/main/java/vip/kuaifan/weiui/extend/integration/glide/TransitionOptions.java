...
import vip.kuaifan.weiui.extend.integration.glide.request.transition.NoTransition;
import vip.kuaifan.weiui.extend.integration.glide.request.transition.TransitionFactory;
import vip.kuaifan.weiui.extend.integration.glide.request.transition.ViewAnimationFactory;
import vip.kuaifan.weiui.extend.integration.glide.request.transition.ViewPropertyAnimationFactory;
import vip.kuaifan.weiui.extend.integration.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link vip.kuaifan.weiui.extend.integration.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.transition.Transition} for each request started with these
