...
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.RecyclableBufferedInputStream;
...
public final class InputStreamRewinder implements DataRewinder<InputStream> {
  ...
  /**
   * Factory for producing {@link vip.kuaifan.weiui.extend.integration.glide.load.data.InputStreamRewinder}s from {@link
