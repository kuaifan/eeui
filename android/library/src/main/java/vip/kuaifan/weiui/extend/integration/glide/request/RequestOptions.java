...
import vip.kuaifan.weiui.extend.integration.glide.load.MultiTransformation;
...
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.CenterCrop;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.CenterInside;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.CircleCrop;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.DownsampleStrategy;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.Downsampler;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.DrawableTransformation;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.FitCenter;
...
import vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawableTransformation;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifOptions;
import vip.kuaifan.weiui.extend.integration.glide.signature.EmptySignature;
...
public class RequestOptions implements Cloneable {
  ...
  /**
   * Returns a {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @NonNull
  ...
  /**
   * Applies a multiplier to the {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}'s size before
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see vip.kuaifan.weiui.extend.integration.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  @NonNull
  @CheckResult
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.DownsampleStrategy.CenterOutside} can safely use
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.stream.HttpGlideUrlLoader}. If you use any other
   * networking library including Glide's Volley or OkHttp integration libraries, this option will
   * be ignored.
   *
   * @see vip.kuaifan.weiui.extend.integration.glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.CenterCrop} to all default types, and
  ...
  /**
   * Applies {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable})
   ...
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link android.graphics.drawable.BitmapDrawable}, and
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformation Any {@link Transformation} for {@link Bitmap}s.
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.TransitionOptions#dontTransition()}</p>
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
  @NonNull
