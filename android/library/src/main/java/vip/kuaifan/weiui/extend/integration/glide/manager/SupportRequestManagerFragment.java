 ...
 *
 * @see vip.kuaifan.weiui.extend.integration.glide.manager.RequestManagerFragment
...
public class SupportRequestManagerFragment extends Fragment {
  ...
  /**
   * Returns the current {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager} or null if none is put.
   */
  @Nullable
