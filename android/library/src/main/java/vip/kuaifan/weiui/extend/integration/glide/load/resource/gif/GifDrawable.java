...
import static vip.kuaifan.weiui.extend.integration.glide.gifdecoder.GifDecoder.TOTAL_ITERATION_COUNT_FOREVER;
...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param frameTransformation An {@link vip.kuaifan.weiui.extend.integration.glide.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(vip.kuaifan.weiui.extend.integration.glide.load.Transformation, android.graphics.Bitmap)
   *
