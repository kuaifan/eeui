package vip.kuaifan.weiui.extend.integration.glide.annotation;
 ...
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions}.
 *
 * <p>All annotated methods will be added to a single
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions} implementation generated per application.
 ...
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions} object with one or more methods called on it.
 * You must not return a newly instantiated {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions} object
 * as doing so my cause a {@code ClassCastException} at runtime. Calling either
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#autoClone()} or
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#lock()} is safe, but unnecessary and should
 ...
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions} object is cloned before it is passed to this
 * method to avoid an option method returning a new instance, but using methods like
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#clone()} or
 * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#autoClone()} can result in options applied in
...
public @interface GlideOption {
   ...
   * {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#autoClone()}.
   *
   ...
   * with {@code vip.kuaifan.weiui.extend.integration.glide.RequestBuilder#apply}. The static factory method by default
   * simply creates a new {@code vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions} object, calls the
