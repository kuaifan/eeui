...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
  ...
  public static final Option<Long> TARGET_FRAME = Option.disk(
      "vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", DEFAULT_FRAME,
  ...
  public static final Option<Integer> FRAME_OPTION = Option.disk(
      "vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption",
