 ...
 * {@link vip.kuaifan.weiui.extend.integration.glide.GlideBuilder} and registering
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder)} for each
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * vip.kuaifan.weiui.extend.integration.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="vip.kuaifan.weiui.extend.integration.glide.samples.flickr.FlickrGlideModule"
