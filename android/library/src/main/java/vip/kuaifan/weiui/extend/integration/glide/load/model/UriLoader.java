...
import vip.kuaifan.weiui.extend.integration.glide.load.data.AssetFileDescriptorLocalUriFetcher;
import vip.kuaifan.weiui.extend.integration.glide.load.data.DataFetcher;
import vip.kuaifan.weiui.extend.integration.glide.load.data.FileDescriptorLocalUriFetcher;
import vip.kuaifan.weiui.extend.integration.glide.load.data.StreamLocalUriFetcher;
 ...
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader} that handles
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.GlideUrl}s.
 *
