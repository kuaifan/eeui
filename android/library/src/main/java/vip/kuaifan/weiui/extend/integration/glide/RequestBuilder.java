...
import static vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions.diskCacheStrategyOf;
import static vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions.signatureOf;
import static vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions.skipMemoryCacheOf;
...
import vip.kuaifan.weiui.extend.integration.glide.request.ErrorRequestCoordinator;
import vip.kuaifan.weiui.extend.integration.glide.request.FutureTarget;
import vip.kuaifan.weiui.extend.integration.glide.request.Request;
import vip.kuaifan.weiui.extend.integration.glide.request.RequestCoordinator;
import vip.kuaifan.weiui.extend.integration.glide.request.RequestFutureTarget;
...
import vip.kuaifan.weiui.extend.integration.glide.request.SingleRequest;
import vip.kuaifan.weiui.extend.integration.glide.request.ThumbnailRequestCoordinator;
import vip.kuaifan.weiui.extend.integration.glide.request.target.PreloadTarget;
import vip.kuaifan.weiui.extend.integration.glide.request.target.Target;
import vip.kuaifan.weiui.extend.integration.glide.request.target.ViewTarget;
import vip.kuaifan.weiui.extend.integration.glide.signature.ApplicationVersionSignature;
 ...
 * {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}.
 */
// Public API.
...
public class RequestBuilder<TranscodeType> implements Cloneable,
   ...
   * vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader}, {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder},
   * and {@link vip.kuaifan.weiui.extend.integration.glide.load.Transformation}s. However,
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#placeholder(int)} and
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#error(int)}, and
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader} or
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#signature(vip.kuaifan.weiui.extend.integration.glide.load.Key)} to
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#signature(vip.kuaifan.weiui.extend.integration.glide.load.Key)}
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * using {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} via
   * {@link RequestOptions#diskCacheStrategy(vip.kuaifan.weiui.extend.integration.glide.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.Transformation}s to these {@link Drawable}s by either extracting
   ...
   * transformed (other than {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link vip.kuaifan.weiui.extend.integration.glide.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see #load(Integer)
   * @see vip.kuaifan.weiui.extend.integration.glide.signature.ApplicationVersionSignature
   */
  @NonNull
  @CheckResult
  @Override
   ...
   *               overridden by
   *               {@link vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see vip.kuaifan.weiui.extend.integration.glide.ListPreloader
   */
  @NonNull
