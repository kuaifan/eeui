...
import vip.kuaifan.weiui.extend.integration.glide.GlideContext;
...
import vip.kuaifan.weiui.extend.integration.glide.load.resource.drawable.DrawableDecoderCompat;
import vip.kuaifan.weiui.extend.integration.glide.request.target.SizeReadyCallback;
...
import vip.kuaifan.weiui.extend.integration.glide.request.transition.TransitionFactory;
...
import vip.kuaifan.weiui.extend.integration.glide.util.pool.StateVerifier;

/**
 * A {@link Request} that loads a {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.Resource} into a given
 * {@link Target}.
 *
