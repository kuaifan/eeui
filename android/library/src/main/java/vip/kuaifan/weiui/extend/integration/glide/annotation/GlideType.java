 ...
 * {@code vip.kuaifan.weiui.extend.integration.glide.RequestManager}.
 *
 * <p>If one or more method is found with this annotation, an additional API entry point that
 * exposes a generated {@code vip.kuaifan.weiui.extend.integration.glide.RequestManager} subclass will be created. The
 ...
 * single parameter must be {@code vip.kuaifan.weiui.extend.integration.glide.RequestBuilder}, with a type
...
public @interface GlideType {
   ...
   *
   * <p>Must match the type of the {@code vip.kuaifan.weiui.extend.integration.glide.RequestBuilder} parameter in the
   * annotated method.
   */
  Class<?> value();
}
