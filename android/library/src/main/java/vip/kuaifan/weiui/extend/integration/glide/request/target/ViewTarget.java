...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   * vip.kuaifan.weiui.extend.integration.glide.request.Request}. </p>
   */
  @Override
  @Nullable
   ...
   *   on older versions, be sure to call {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager#clear(View)} on
