...
/**
 * A class that allows {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
