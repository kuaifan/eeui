...
/**
 * A collection of static methods for creating new {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager}s or
 * retrieving existing ones from activities and fragment.
 */
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting
  static final String FRAGMENT_TAG = "vip.kuaifan.weiui.extend.integration.glide.manager";
