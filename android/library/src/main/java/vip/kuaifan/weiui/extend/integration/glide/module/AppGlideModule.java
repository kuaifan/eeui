 ...
 * {@link vip.kuaifan.weiui.extend.integration.glide.annotation.GlideModule} to be processed correctly.
 *
 * <p>Classes that extend {@link AppGlideModule} can optionally be annotated with
 * {@link vip.kuaifan.weiui.extend.integration.glide.annotation.Excludes} to optionally exclude one or more
