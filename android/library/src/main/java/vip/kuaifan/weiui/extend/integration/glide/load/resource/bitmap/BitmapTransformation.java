...
/**
 * A simple {@link vip.kuaifan.weiui.extend.integration.glide.load.Transformation} for transforming
 * {@link android.graphics.Bitmap}s that abstracts away dealing with
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.Resource} objects for subclasses.
 *
 * Use cases will look something like this:
 * <pre>
 * <code>
 * public class FillSpace extends BitmapTransformation {
 *     private static final String ID = "vip.kuaifan.weiui.extend.integration.glide.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target#SIZE_ORIGINAL},
   * this class converts them to be the size of the Bitmap we're going to transform before calling
   * this method.
   *
   * @param pool        A {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} that can
