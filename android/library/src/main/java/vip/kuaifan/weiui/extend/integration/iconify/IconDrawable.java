...
import vip.kuaifan.weiui.extend.integration.iconify.internal.IconFontDescriptorWrapper;
...
public class IconDrawable extends Drawable {
    ...
    private vip.kuaifan.weiui.extend.integration.iconify.Icon icon;
    ...
    public IconDrawable(Context context, String iconKey) {
        vip.kuaifan.weiui.extend.integration.iconify.Icon icon = vip.kuaifan.weiui.extend.integration.iconify.Iconify.findIconForKey(iconKey);
        if (icon == null) {
     ...
     */
    public IconDrawable(Context context, vip.kuaifan.weiui.extend.integration.iconify.Icon icon) {
        init(context, icon);
    }

    private void init(Context context, vip.kuaifan.weiui.extend.integration.iconify.Icon icon) {
