...
import vip.kuaifan.weiui.extend.integration.glide.load.data.InputStreamRewinder;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.Engine;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.ArrayPool;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.MemoryCache;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.prefill.BitmapPreFiller;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.prefill.PreFillType;
import vip.kuaifan.weiui.extend.integration.glide.load.model.AssetUriLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.ByteArrayLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.ByteBufferEncoder;
import vip.kuaifan.weiui.extend.integration.glide.load.model.ByteBufferFileLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.DataUrlLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.FileLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.GlideUrl;
import vip.kuaifan.weiui.extend.integration.glide.load.model.MediaStoreFileLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.ResourceLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.StreamEncoder;
import vip.kuaifan.weiui.extend.integration.glide.load.model.StringLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.UnitModelLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.UriLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.UrlUriLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.stream.HttpGlideUrlLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.stream.HttpUriLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.stream.MediaStoreImageThumbLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.stream.MediaStoreVideoThumbLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.model.stream.UrlLoader;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.BitmapDrawableDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.BitmapDrawableEncoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.BitmapEncoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.DefaultImageHeaderParser;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.Downsampler;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.ResourceBitmapDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.StreamBitmapDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.UnitBitmapDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.VideoDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bytes.ByteBufferRewinder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.drawable.ResourceDrawableDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.drawable.UnitDrawableDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.file.FileDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.ByteBufferGifDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawableEncoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifFrameResourceDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.StreamGifDecoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.BitmapBytesTranscoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.BitmapDrawableTranscoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.DrawableBytesTranscoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.GifDrawableBytesTranscoder;
import vip.kuaifan.weiui.extend.integration.glide.manager.ConnectivityMonitorFactory;
import vip.kuaifan.weiui.extend.integration.glide.manager.RequestManagerRetriever;
import vip.kuaifan.weiui.extend.integration.glide.module.ManifestParser;
import vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions;
import vip.kuaifan.weiui.extend.integration.glide.request.target.ImageViewTargetFactory;
 ...
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder builder) {
    ...
    List<vip.kuaifan.weiui.extend.integration.glide.module.GlideModule> manifestModules = Collections.emptyList();
    ...
    if (annotationGeneratedModule != null
      ...
      Iterator<vip.kuaifan.weiui.extend.integration.glide.module.GlideModule> iterator = manifestModules.iterator();
      while (iterator.hasNext()) {
        vip.kuaifan.weiui.extend.integration.glide.module.GlideModule current = iterator.next();
    ...
    if (Log.isLoggable(TAG, Log.DEBUG)) {
      for (vip.kuaifan.weiui.extend.integration.glide.module.GlideModule glideModule : manifestModules) {
    ...
    for (vip.kuaifan.weiui.extend.integration.glide.module.GlideModule module : manifestModules) {
    ...
    try {
      Class<GeneratedAppGlideModule> clazz =
          (Class<GeneratedAppGlideModule>)
              Class.forName("vip.kuaifan.weiui.extend.integration.glide.GeneratedAppGlideModuleImpl");
  ...
  /**
   * Returns the {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} used to
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder}s and
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.Transformation}s. Use outside of these classes is not generally
   * recommended. </p>
   */
  @NonNull
  ...
  /**
   * Pre-fills the {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} using the given
   * sizes.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.prefill.PreFillType.Builder Builders} representing
