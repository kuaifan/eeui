...
public interface RequestListener<R> {
   ...
   * use {@link vip.kuaifan.weiui.extend.integration.glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, vip.kuaifan.weiui.extend.integration.glide.request.transition.Transition)}.
   *
