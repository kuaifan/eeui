...
import static vip.kuaifan.weiui.extend.integration.glide.request.RequestOptions.decodeTypeOf;
...
import vip.kuaifan.weiui.extend.integration.glide.manager.ConnectivityMonitor;
import vip.kuaifan.weiui.extend.integration.glide.manager.ConnectivityMonitorFactory;
import vip.kuaifan.weiui.extend.integration.glide.manager.Lifecycle;
import vip.kuaifan.weiui.extend.integration.glide.manager.LifecycleListener;
import vip.kuaifan.weiui.extend.integration.glide.manager.RequestManagerTreeNode;
import vip.kuaifan.weiui.extend.integration.glide.manager.RequestTracker;
import vip.kuaifan.weiui.extend.integration.glide.manager.TargetTracker;
...
public class RequestManager implements LifecycleListener,
   ...
   * vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
   ...
   * vip.kuaifan.weiui.extend.integration.glide.load.engine.DiskCacheStrategy#DATA}. As a result, specifying a
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.DiskCacheStrategy} on this request is generally not
   * recommended.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder}s
