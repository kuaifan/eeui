package vip.kuaifan.weiui.extend.integration.glide.load.engine.executor;
...
public final class GlideExecutor implements ExecutorService {
   ...
   * prefix, and the
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT}
   ...
   * {@link #calculateBestThreadCount()}, the {@link #DEFAULT_DISK_CACHE_EXECUTOR_NAME} thread name
   * prefix, and a custom
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}
   * uncaught throwable strategy.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   * @param uncaughtThrowableStrategy The {@link
   * vip.kuaifan.weiui.extend.integration.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} to use to
   ...
   * and {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
