...
public abstract class DiskCacheStrategy {
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.data.DataFetcher} and the
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.EncodeStrategy} of the
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceEncoder} (if an
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceEncoder} is available).
   */
   ...
   * vip.kuaifan.weiui.extend.integration.glide.load.ResourceEncoder} will use to encode the resource.
   */
