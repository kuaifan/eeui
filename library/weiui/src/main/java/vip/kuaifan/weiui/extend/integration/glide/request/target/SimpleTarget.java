...
/**
 * A simple {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target} base class with default (usually no-op)
 ...
 * to the previous instance and either call {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager#clear(Target)}
 * on the old instance before starting a new load or you must re-use the old instance for the new
 * load. Glide's {@link vip.kuaifan.weiui.extend.integration.glide.RequestBuilder#into(Target)} method returns the
 ...
 * calling {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager#clear(Target)} and you should always null out
