...
import vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.LruArrayPool;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.LruBitmapPool;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.DiskCache;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.LruResourceCache;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.MemoryCache;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.MemorySizeCalculator;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.executor.GlideExecutor;
import vip.kuaifan.weiui.extend.integration.glide.manager.ConnectivityMonitorFactory;
import vip.kuaifan.weiui.extend.integration.glide.manager.DefaultConnectivityMonitorFactory;
import vip.kuaifan.weiui.extend.integration.glide.manager.RequestManagerRetriever;
import vip.kuaifan.weiui.extend.integration.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.MemoryCache} implementation to store
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.DiskCache} implementation to use to store
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.Resource} data and thumbnails.
   *
   ...
   * use {@link #setDiskCache(vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.DiskCache.Factory)} instead.
  ...
  /**
   * Sets the {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.cache.DiskCache} to use to store {@link
   * vip.kuaifan.weiui.extend.integration.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable} or
  ...
  /**
   * Sets the {@link vip.kuaifan.weiui.extend.integration.glide.load.DecodeFormat} that will be the default format for all
   ...
   * vip.kuaifan.weiui.extend.integration.glide.load.DecodeFormat} for more details. </p>
   *
  ...
  /**
   * Sets the {@link vip.kuaifan.weiui.extend.integration.glide.manager.ConnectivityMonitorFactory}
   * to use to notify {@link vip.kuaifan.weiui.extend.integration.glide.RequestManager} of connectivity events.
   * If not set {@link vip.kuaifan.weiui.extend.integration.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}s which are subsequently de-referenced and
   ...
   * load resources into {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}s and then never clear the
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}. To do so, Glide uses
   * {@link java.lang.ref.WeakReference}s to track resources that belong to
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}s that haven't yet been cleared. Setting
   * this method to {@code true} allows Glide to also maintain a hard reference to the underlying
   * resource so that if the {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target} is garbage collected,
   ...
   * resources into {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}s but never clear them.
   *
   ...
   * clear the corresponding {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target} used to load the
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}s when you're done with the corresponding
   * resource. Clearing {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}s allows Glide to maximize
