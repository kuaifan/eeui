...
/**
 * A factory class that produces a functional {@link vip.kuaifan.weiui.extend.integration.glide.manager.ConnectivityMonitor}
 * if the application has the {@code android.permission.ACCESS_NETWORK_STATE} permission and a no-op
 * non functional {@link vip.kuaifan.weiui.extend.integration.glide.manager.ConnectivityMonitor} if the app does not have
