...
import vip.kuaifan.weiui.extend.integration.glide.load.data.DataRewinder;
import vip.kuaifan.weiui.extend.integration.glide.load.data.DataRewinderRegistry;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.DecodePath;
import vip.kuaifan.weiui.extend.integration.glide.load.engine.LoadPath;
...
import vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoaderRegistry;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.ResourceTranscoder;
import vip.kuaifan.weiui.extend.integration.glide.load.resource.transcode.TranscoderRegistry;
import vip.kuaifan.weiui.extend.integration.glide.provider.EncoderRegistry;
import vip.kuaifan.weiui.extend.integration.glide.provider.ImageHeaderParserRegistry;
import vip.kuaifan.weiui.extend.integration.glide.provider.LoadPathCache;
import vip.kuaifan.weiui.extend.integration.glide.provider.ModelToResourceClassCache;
import vip.kuaifan.weiui.extend.integration.glide.provider.ResourceDecoderRegistry;
import vip.kuaifan.weiui.extend.integration.glide.provider.ResourceEncoderRegistry;
import vip.kuaifan.weiui.extend.integration.glide.util.pool.FactoryPools;
...
public class Registry {
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable} etc).
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link vip.kuaifan.weiui.extend.integration.glide.load.data.DataRewinder.Factory} to handle a
  ...
  /**
   * Thrown when no {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader} is registered for a given
   * model class.
   */
