...
import vip.kuaifan.weiui.extend.integration.iconify.internal.ParsingUtil;
...
public class Iconify {
     ...
     */
    public static IconFontDescriptorWrapper findTypefaceOf(vip.kuaifan.weiui.extend.integration.iconify.Icon icon) {
     ...
     */
    public static vip.kuaifan.weiui.extend.integration.iconify.Icon findIconForKey(String iconKey) {
        for (int i = 0, iconFontDescriptorsSize = iconFontDescriptors.size(); i < iconFontDescriptorsSize; i++) {
            ...
            vip.kuaifan.weiui.extend.integration.iconify.Icon icon = iconFontDescriptor.getIcon(iconKey);
