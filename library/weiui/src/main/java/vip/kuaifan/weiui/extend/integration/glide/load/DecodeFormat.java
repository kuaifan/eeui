 ...
 * {@link android.graphics.Bitmap}s returned by {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.Downsampler}s support setting formats and certain
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link vip.kuaifan.weiui.extend.integration.glide.load.ResourceDecoder}.
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.Downsampler#ALLOW_HARDWARE_CONFIG} to false
   * instead.
   */
  @Deprecated
