package vip.kuaifan.weiui.extend.integration.xutils.common.task;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((vip.kuaifan.weiui.extend.integration.xutils.common.Callback.CancelledException) args[0]);
                        break;
                    }
