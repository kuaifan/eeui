...
/**
 * A utility class for obtaining a {@link vip.kuaifan.weiui.extend.integration.glide.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link vip.kuaifan.weiui.extend.integration.glide.load.Key} for version code of the Application
