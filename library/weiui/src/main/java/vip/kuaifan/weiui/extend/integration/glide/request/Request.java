...
/**
 * A request that loads a resource for an {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}.
 */
public interface Request {
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.request.target.Target}s (for example). Using a similar but different
