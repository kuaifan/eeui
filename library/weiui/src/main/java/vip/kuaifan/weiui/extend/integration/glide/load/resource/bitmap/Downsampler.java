...
import vip.kuaifan.weiui.extend.integration.glide.load.ImageHeaderParser.ImageType;
import vip.kuaifan.weiui.extend.integration.glide.load.ImageHeaderParserUtils;
...
import vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
import vip.kuaifan.weiui.extend.integration.glide.util.LogTime;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.Downsampler.DownsampleStrategy",
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   ...
   * provided  {@link vip.kuaifan.weiui.extend.integration.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link vip.kuaifan.weiui.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
