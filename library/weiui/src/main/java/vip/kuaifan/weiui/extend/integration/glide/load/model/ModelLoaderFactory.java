 ...
 *
 * @param <T> The type of the model the {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader}s built by
 *            this factory can handle
 * @param <Y> The type of data the {@link vip.kuaifan.weiui.extend.integration.glide.load.model.ModelLoader}s built by this
 *            factory can load.
 */
