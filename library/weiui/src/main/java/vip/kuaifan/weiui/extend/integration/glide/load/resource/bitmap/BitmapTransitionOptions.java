...
import vip.kuaifan.weiui.extend.integration.glide.TransitionOptions;
import vip.kuaifan.weiui.extend.integration.glide.request.transition.BitmapTransitionFactory;
import vip.kuaifan.weiui.extend.integration.glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see vip.kuaifan.weiui.extend.integration.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see vip.kuaifan.weiui.extend.integration.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
